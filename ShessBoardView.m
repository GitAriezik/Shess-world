...
@implementation ShessBoardView

//в данном классе описываем шахмотное поле

+ (void) set_View:(UIView*)view {
    
    
    //цвет для белого квадратика:
    UIImage * image_White = [UIImage imageNamed:@"white.png"];
    
    
    //цвет для черного квадратика:
    UIImage * image_Black = [UIImage imageNamed:@"black.png"];
