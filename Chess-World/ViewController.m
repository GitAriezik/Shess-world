...
@property (nonatomic,  weak) UIView * ShessBoardView;
...
- (void)viewDidLoad {
    ...
    [ShessBoardView set_View:chessBoardView]; //вызов метода класса с шахматным полем (делаю через доп. вью, чтобы нельзя было двигать элементы доски)
